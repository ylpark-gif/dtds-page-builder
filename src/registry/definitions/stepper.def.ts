  ...
  customRenderer: (node) => {
    ...
    return React.createElement(Stepper, { value: '2', orientation, size },
      React.createElement(StepperList, null,
        React.createElement(StepperItem, { value: '1', step: 1, title: '단계 1' } as any),
        React.createElement(StepperSeparator, null),
        React.createElement(StepperItem, { value: '2', step: 2, title: '단계 2' } as any),
        React.createElement(StepperSeparator, null),
        React.createElement(StepperItem, { value: '3', step: 3, title: '단계 3' } as any)
      )
    )
  },
}
