  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f9f9f9', ...dsBase }}>
      ...
      >
        ...
        >
          <li>
            <span style={{ fontWeight: 500, fontSize: 16, color: '#999999', fontFamily: font, lineHeight: '148%' }}>
              닥톡 예약이 처음이신가요?{' '}
              <span style={{ textDecoration: 'underline', fontWeight: 700 }}>가입 신청하기</span>
            </span>
          </li>
          <li>
            <span style={{ fontWeight: 500, fontSize: 16, color: '#999999', fontFamily: font, lineHeight: '148%' }}>
              전문가 QnA 회원이신가요?{' '}
              <span style={{ textDecoration: 'underline', fontWeight: 700 }}>전문가 QnA 서비스 로그인하기</span>
            </span>
          </li>
        </ul>
      </section>
...
function OriginalSettingsHospitalPreview() {
  return (
    <SettingsLayout>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 1080, width: '100%', padding: '0 40px' }}>
        <h1 style={dsSectionTitle}>병원정보</h1>
...
function OriginalSettingsPlatformPreview() {
  const platforms = [
    { name: '네이버', status: '운영 중', statusColor: colors.dg600 },
    { name: '카카오', status: '검수중', statusColor: colors.gray600 },
    { name: '당근', status: '운영 중', statusColor: colors.dg600 },
  ]

  return (
    <SettingsLayout>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 1080, width: '100%', padding: '0 40px' }}>
        <h1 style={dsSectionTitle}>플랫폼</h1>
        <div style={dsCard}>
            ...
            {platforms.map((p, i) => (
              <React.Fragment key={p.name}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: 18, fontWeight: 700, color: p.statusColor, fontFamily: font }}>{p.status}</span>
                </div>
              </React.Fragment>
            ))}
          </div>
...
function OriginalSettingsProductListPreview() {
  ...
  return (
    <SettingsLayout>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 1280, width: '100%', padding: '0 40px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <h1 style={dsSectionTitle}>예약 상품</h1>
...
function OriginalSettingsProductDetailPreview() {
  return (
    <SettingsLayout>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 1280, width: '100%', padding: '0 40px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <button style={{ ...dsBtnGhost, fontSize: 20, padding: 4 }}>&#x2190;</button>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: colors.gray1000, margin: 0, fontFamily: font }}>일반 진료</h1>
        </div>
        {/* Tabs */}
        <div style={{ display: 'flex', borderBottom: `2px solid ${colors.gray100}` }}>
          <div
            style={{
              padding: '12px 16px',
              fontWeight: 600,
              fontSize: 14,
              color: colors.gray1000,
              borderBottom: `2px solid ${colors.gray1000}`,
              marginBottom: -2,
              fontFamily: font,
            }}
          >
          ...
          <div style={{ padding: '12px 16px', fontWeight: 500, fontSize: 14, color: colors.gray600, fontFamily: font }}>
            기본정보
          </div>
        </div>
        {/* Card */}
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f9f9f9', ...dsBase }}>
      ...
      >
        ...
        >
          <h2 style={{ fontSize: 28, fontWeight: 700, color: colors.gray1000, margin: 0, fontFamily: font }}>아이디 찾기</h2>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            <p style={{ color: colors.gray600, fontSize: 16, margin: 0, fontFamily: font, lineHeight: '148%' }}>
          ...
          <div style={{ borderTop: `1px solid ${colors.gray100}`, paddingTop: 24, textAlign: 'center' }}>
            <span style={{ color: colors.gray600, fontSize: 14, fontFamily: font }}>등록된 휴대폰 번호가 없나요? </span>
            <button style={{ ...dsBtnGhost, color: colors.gray600 }}>문의하기</button>
          </div>
        </article>
      </section>
    </div>
...
function OriginalApplicationPreview() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', backgroundColor: colors.white, ...dsBase }}>
      ...
      {/* Content */}
      <main style={{ flex: 1, display: 'flex', justifyContent: 'center', paddingTop: 126 }}>
...
function OriginalLinkingPlatformPreview() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f9f9f9', ...dsBase }}>
      <section style={{ width: 600, padding: '24px 0 48px', display: 'flex', flexDirection: 'column', gap: 24 }}>
        <h2 style={dsSectionTitle}>플랫폼 연동</h2>
...
function OriginalLoadNaverProductPreview() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', backgroundColor: '#f9f9f9', alignItems: 'center', justifyContent: 'center', ...dsBase }}>
...
function OriginalNaverKinPaymentPreview() {
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 50, textAlign: 'center' }}>
        {/* Title */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <h1 style={{ fontSize: 40, fontWeight: 700, color: colors.gray1000, margin: 0, fontFamily: font }}>
            네이버 지식iN 결제 수단 등록
          </h1>
          <p style={{ fontSize: 22, color: '#8a9299', margin: 0, fontFamily: font }}>
        ...
        {/* Notice list */}
        <div style={{ textAlign: 'left', width: '100%', maxWidth: 600 }}>
          <h3 style={{ fontSize: 18, fontWeight: 700, color: colors.gray1000, margin: '0 0 16px', fontFamily: font }}>유의사항</h3>
          <ul
            style={{
              listStyle: 'disc',
              padding: '0 0 0 20px',
          ...
          >
            <li>결제수단 등록 시 0원이 결제됩니다. (자동 취소)</li>
            <li>등록하신 결제수단으로 매월 10일에 정기 결제됩니다.</li>
            <li>카드 정보 변경은 결제수단 관리 페이지에서 가능합니다.</li>
            <li>해지는 고객센터로 문의해주세요.</li>
          </ul>
        </div>
      </div>
    </div>
...
function OriginalProductDetailPreview() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.white, ...dsBase }}>
      <div style={{ width: 600, padding: '24px 0 48px', display: 'flex', flexDirection: 'column', gap: 24 }}>
...
function OriginalLinkKeyPreview() {
  return (
    ...
    >
      ...
      />
      <p style={{ color: colors.gray600, fontSize: 16, margin: 0, fontFamily: font }}>연동 처리 중...</p>
    </div>
  )
}
...
const originalPreviewMap: Record<string, React.ComponentType> = {
  ...
  '/reservation-auto-login': () => <OriginalLoadingPreview text="자동 로그인 중..." />,
  '/': OriginalHomePreview,
